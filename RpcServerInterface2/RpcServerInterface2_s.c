...
extern const MIDL_SERVER_INFO RpcServerInterface2_ServerInfo;

extern const RPC_DISPATCH_TABLE RpcServerInterface2_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE RpcServerInterface2___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xfa161e81,0x6e93,0x4f41,{0x96,0x1c,0xee,0x9c,0x2e,0x75,0xde,0x18}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&RpcServerInterface2_v1_0_DispatchTable,
    0,
    0,
    0,
    &RpcServerInterface2_ServerInfo,
    0x06000000
    };
RPC_IF_HANDLE RpcServerInterface2_v1_0_s_ifspec = (RPC_IF_HANDLE)& RpcServerInterface2___RpcServerInterface;
...
static const RPC_DISPATCH_FUNCTION RpcServerInterface2_table[] =
    {
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE RpcServerInterface2_v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)RpcServerInterface2_table
    };
...
static const MIDL_STUB_DESC RpcServerInterface2_StubDesc = 
    {
    (void *)& RpcServerInterface2___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& RpcServerInterface2_ServerInfo,   /* proxy/server info */
    0
    };

static const RPC_DISPATCH_FUNCTION RpcServerInterface2_NDR64__table[] =
    {
    NdrServerCallAll,
    0
    };
static const RPC_DISPATCH_TABLE RpcServerInterface2_NDR64__v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)RpcServerInterface2_NDR64__table
    };
...
static const MIDL_SYNTAX_INFO RpcServerInterface2_SyntaxInfo [  2 ] = 
    ...
    ,{
    {{0x71710533,0xbeba,0x4937,{0x83,0x19,0xb5,0xdb,0xef,0x9c,0xcc,0x36}},{1,0}},
    (RPC_DISPATCH_TABLE*)&RpcServerInterface2_NDR64__v1_0_DispatchTable,
    0 ,
...
static const SERVER_ROUTINE RpcServerInterface2_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)Shutdown2
    };

static const MIDL_SERVER_INFO RpcServerInterface2_ServerInfo = 
    {
    &RpcServerInterface2_StubDesc,
    RpcServerInterface2_ServerRoutineTable,
    RpcServerInterface2__MIDL_ProcFormatString.Format,
    (unsigned short *) RpcServerInterface2_FormatStringOffsetTable,
    0,
